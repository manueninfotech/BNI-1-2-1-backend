...
router.put("/conclaves/:id", asyncHandler(c.update));
router.delete("/conclaves/:id", asyncHandler(c.deleteConclave));
...
router.post("/users/:uid/role", asyncHandler(c.setUserRole));
